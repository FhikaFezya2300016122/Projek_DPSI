...
const Register = () => {
    ...
    const handleEmailRegister = async (e) => {
        ...
        // Mendaftarkan dan langsung me-login-kan pengguna
        ...
        if (error) {
            ...
            // Arahkan langsung ke halaman pemilihan peran
...
import logo from "../Images/Icon.png"; // Import logo
...
export default function RegisterForm() {
  ...
  const handleSubmit = (e) => {
    ...
    // Di sini kamu bisa tambahkan validasi jika perlu
    navigate('/roleselection'); // Navigasi ke halaman Role Selection
  };
