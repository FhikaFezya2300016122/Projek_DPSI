...
export default function RegisterForm() {
  ...
  const handleGoogleRegister = () => {
    ...
    setTimeout(() => login(), 1000); // Delay for visual effect
  };
  ...
  if (showGoogleUI) {
    return (
      <div className="min-h-screen flex justify-center items-center bg-slate-100">
        <div className="w-[1040px] min-h-96 px-9 pt-28 pb-9 bg-white rounded-3xl inline-flex flex-col justify-center items-start">
